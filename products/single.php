...
<div class="wrapper-container">
    ...
    <nav class="breadcrumb" aria-label="breadcrumbs">
        ...
        <a href="/collections/mens-sneakers" title="">Men Sneakers</a>
            ...
            <div class="grid__item">
                ...
                <div class="grid__item grid__item">
                    <div itemscope="" itemtype="http://schema.org/Product" class="single-product-layout-type-1">
                        <meta itemprop="url"
                            content="https://pr-fashion-2.myshopify.com/products/c122-1058396-mens-canvas-sneakers-breathable-soft-sole-lace-up-casual-shoes">
                        <meta itemprop="image"
                            content="//cdn.shopify.com/s/files/1/0084/1144/7356/products/1058396_850x.jpg?v=1586948473">
                        <div class="product-single">
                            ...
                            <div class="grid__item wide--one-half post-large--one-half large--one-half product-img-box">
                                ...
                                <div class="product-photo-container">
                                    ...
                                    <a
                                        ...
                                        <img id="product-featured-images" src="<?php echo $single['featured_image']; ?>"
                                ...
                                <div class="more-view-wrapper   more-view-wrapper-owlslider ">
                                    ...
                                    <ul id="ProductThumbs" class="product-photo-thumbs  owl-carousel owl-drag">
                            ...
                            <div
                                ...
                                <p class="product-arrows">
                                    <span class="right">
                                        <a
                                            href="/collections/mens-sneakers/products/c122-1076222-men-breathable-elastic-bnad-slip-on-casual-sneakers#content">
                                ...
                                <div class="product_single_price">
                                    <div class="product_price">
                                        <div class="grid-link__org_price" id="ProductPrice"><?php echo $single['price'] ?></div>
                                    </div>
                                ...
                                <div class="product-description rte" itemprop="description">
                                    Our Size US Size Length Width 39 6.5 9.65 3.59 40 7.5 9.84 3.66 41 8 10.04 3.74 42
                                    8.5 10.24 3.81 43 9 10.43 3.88 44 10 10.63 3.96 45 10.5 10.83 4.03 46 11 11.02 4.10
                                    47 11.5 11.22 4.18 48 12 11.42 4.25 49 13 11.61 4.33...
                                </div>
                                        ...
                                        <div class="selector-wrapper-secton">
                                            ...
                                            <div class="swatch clearfix" data-option-index="0">
                                                ...
                                                <div class="swatch-section">
                                                    ...
                                                    <div data-value="KHAKI"
                                                        class="swatch-element color khaki available">

                                                        <div class="tooltip">KHAKI</div>

                                                        <input id="swatch-0-khaki" type="radio" name="option-0"
                                                            value="KHAKI">

                                                        <label for="swatch-0-khaki"
                                                            style="background-color: khaki; background-image: url(//cdn.shopify.com/s/files/1/0084/1144/7356/files/khaki.png?0)">
                                                            <img class="crossed-out"
                                                                src="//cdn.shopify.com/s/files/1/0084/1144/7356/t/3/assets/soldout.png?v=6625312704354037208">
                                                        </label>
                                                    ...
                                                    <div data-value="BLACK"
                                                        ...
                                                        <label for="swatch-0-black"
                                                            style="background-color: black; background-image: url(//cdn.shopify.com/s/files/1/0084/1144/7356/files/black.png?0)">
                                                            <img class="crossed-out"
                                                                src="//cdn.shopify.com/s/files/1/0084/1144/7356/t/3/assets/soldout.png?v=6625312704354037208">
                                                        </label>
                                                    ...
                                                    <div data-value="BLUE" class="swatch-element color blue available">
                                                        ...
                                                        <label for="swatch-0-blue"
                                                            style="background-color: blue; background-image: url(//cdn.shopify.com/s/files/1/0084/1144/7356/files/blue.png?0)">
                                                            <img class="crossed-out"
                                                                src="//cdn.shopify.com/s/files/1/0084/1144/7356/t/3/assets/soldout.png?v=6625312704354037208">
                                                        </label>
                                            ...
                                            <div class="swatch clearfix" data-option-index="1">
                                                ...
                                                <div class="swatch-section">
                                                    ...
                                                    <div data-value="7.5" class="swatch-element 7-5 available">
                                                        ...
                                                        <input id="swatch-1-7-5" type="radio" name="option-1"
                                                            value="7.5">
                                                    ...
                                                    <div data-value="8.5" class="swatch-element 8-5 available">
                                                        ...
                                                        <input id="swatch-1-8-5" type="radio" name="option-1"
                                                            value="8.5">
                                            ...
                                            <div class="selector-wrapper" style="display: none;"><label
                                                    for="productSelect-option-1">SIZE(US)</label>
                                                <div class="selector-arrow"><select class="single-option-selector"
                                                ...
                                                <option selected="selected" value="31960425103420">KHAKI / 8</option>

                                                <option value="31960425136188">BLACK / 8</option>

                                                <option value="31960425168956">BLUE / 8</option>

                                                <option value="31960425201724">KHAKI / 9</option>

                                                <option value="31960425234492">BLACK / 9</option>

                                                <option value="31960425267260">BLUE / 9</option>

                                                <option value="31960425300028">KHAKI / 7.5</option>

                                                <option value="31960425332796">BLACK / 7.5</option>

                                                <option value="31960425365564">BLUE / 7.5</option>

                                                <option value="31960425431100">KHAKI / 8.5</option>

                                                <option value="31960425463868">BLACK / 8.5</option>

                                                <option value="31960425496636">BLUE / 8.5</option>
                                        ...
                                        <div class="product-single__quantity ">
                                            <div class="quantity-box-section">
                                                ...
                                                <div class="total-price">
                                                    <label>Subtotal : </label><span>$39.39</span>
                                                </div>
                                ...
                                <div class="add-to-wishlist">
                                    <div class="show">
                                        ...
                                        <div class="loadding-wishbutton-c122-1058396-mens-canvas-sneakers-breathable-soft-sole-lace-up-casual-shoes loading btn"
                        ...
                        <div class="dt-sc-tabs-container">
                            ...
                            <div class="dt-sc-tabs-content" id="desc_pro" style="display: block;">
                                <p>
                                    <style>
                                    .size_table_start table,
                                    .size_table_start table tr td {
                                ...
                                <div>
                                    <strong>Brand: No</strong><strong>Description:</strong>1.Shoe&nbsp;Type:
                                    Sneaker2.Gender: Men3.Season: Spring,Summer,Autumn4.Occasion:
                                    Casual,Sport5.Toe:Round
                                    Toe&nbsp;6.Closure&nbsp;Type:Lace-up7.Color:Black,Blue,KhakiMaterial:Upper&nbsp;Material:
                                    CanvasOutsole&nbsp;Material:&nbsp;<span
                                        style="color: rgb(51, 51, 51); font-family: Arial, Helvetica, sans-senif, SimSun, 宋体; font-size: 13px; line-height: 18px;">Rubber</span><strong>Size&nbsp;Chart:</strong>
                                    <div class="table-wrapper">
                                        <table height="232" width="618">
                                            <tbody>
                                                <tr>
                                                    <td colspan="8" style="width: 663px; text-align: center;">
                                                        Men's&nbsp;Size&nbsp;Chart</td>
                                                </tr>
                                                <tr>
                                                    <td rowspan="2" style="width: 58px; text-align: center;">&nbsp;Size
                                                    </td>
                                                    <td rowspan="2" style="width: 67px; text-align: center;">&nbsp;CN
                                                    </td>
                                                    <td rowspan="2" style="width: 80px; text-align: center;">&nbsp;US
                                                    </td>
                                                    <td rowspan="2" style="width: 82px; text-align: center;">&nbsp;UK
                                                    </td>
                                                    <td rowspan="2" style="width: 84px; text-align: center;">&nbsp;EUR
                                                    </td>
                                                    <td rowspan="2" style="width: 79px; text-align: center;">&nbsp;AU
                                                    </td>
                                                    <td colspan="2" style="width: 214px; text-align: center;">Feet&nbsp;
                                                        Length</td>
                                                </tr>
                                                <tr>
                                                    <td style="width: 96px; text-align: center;">MM</td>
                                                    <td style="width: 117px; text-align: center;">Inches</td>
                                                </tr>
                                                <tr>
                                                    <td style="width: 58px; text-align: center;">7.5</td>
                                                    <td style="width: 67px; text-align: center;">41</td>
                                                    <td style="width: 80px; text-align: center;">7.5</td>
                                                    <td style="width: 82px; text-align: center;">7</td>
                                                    <td style="width: 84px; text-align: center;">41</td>
                                                    <td style="width: 79px; text-align: center;">7.5</td>
                                                    <td style="width: 96px; text-align: center;">(248-253)</td>
                                                    <td style="width: 117px; text-align: center;">(9.8''-10.0'')</td>
                                                </tr>
                                                <tr>
                                                    <td style="width: 58px; text-align: center;">8</td>
                                                    <td style="width: 67px; text-align: center;">42</td>
                                                    <td style="width: 80px; text-align: center;">8</td>
                                                    <td style="width: 82px; text-align: center;">7.5</td>
                                                    <td style="width: 84px; text-align: center;">42</td>
                                                    <td style="width: 79px; text-align: center;">8</td>
                                                    <td style="width: 96px; text-align: center;">(253-258)</td>
                                                    <td style="width: 117px; text-align: center;">(10.0''-10.2'')</td>
                                                </tr>
                                                <tr>
                                                    <td style="width: 58px; text-align: center;">8.5</td>
                                                    <td style="width: 67px; text-align: center;">43</td>
                                                    <td style="width: 80px; text-align: center;">8.5</td>
                                                    <td style="width: 82px; text-align: center;">8</td>
                                                    <td style="width: 84px; text-align: center;">43</td>
                                                    <td style="width: 79px; text-align: center;">8.5</td>
                                                    <td style="width: 96px; text-align: center;">(258-263)</td>
                                                    <td style="width: 117px; text-align: center;">(10.2''-10.4'')</td>
                                                </tr>
                                                <tr>
                                                    <td style="width: 58px; text-align: center;">9</td>
                                                    <td style="width: 67px; text-align: center;">44</td>
                                                    <td style="width: 80px; text-align: center;">9</td>
                                                    <td style="width: 82px; text-align: center;">8.5</td>
                                                    <td style="width: 84px; text-align: center;">44</td>
                                                    <td style="width: 79px; text-align: center;">9</td>
                                                    <td style="width: 96px; text-align: center;">(263-268)</td>
                                                    <td style="width: 117px; text-align: center;">(10.4''-10.6'')</td>
                                                </tr>
                                                <tr>
                                                    <td colspan="8" style="width:663px;">
                                                        SIZE&nbsp;EXPLIAN&nbsp;(Required):1.Please&nbsp;according&nbsp;your&nbsp;feet&nbsp;length&nbsp;to&nbsp;choose&nbsp;your&nbsp;suitable&nbsp;size.2.Please&nbsp;place&nbsp;your&nbsp;order&nbsp;in&nbsp;US&nbsp;size&nbsp;,however&nbsp;the&nbsp;tags&nbsp;inside&nbsp;the&nbsp;shoes&nbsp;may&nbsp;show&nbsp;in&nbsp;CN/EUR&nbsp;size.3.Some&nbsp;tags&nbsp;inside&nbsp;shoes&nbsp;showing&nbsp;a&nbsp;UK&nbsp;or&nbsp;US&nbsp;size&nbsp;may&nbsp;be&nbsp;different&nbsp;with&nbsp;our&nbsp;size&nbsp;chart,please&nbsp;base&nbsp;on&nbsp;our&nbsp;size&nbsp;chart.4.The&nbsp;size&nbsp;of&nbsp;these&nbsp;shoes&nbsp;are&nbsp;smaller&nbsp;than&nbsp;ordinary,&nbsp;we&nbsp;suggest&nbsp;buying&nbsp;a&nbsp;bigger&nbsp;one&nbsp;size.
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                    <strong>Package&nbsp;included:</strong>1*pair&nbsp;of&nbsp;shoes(without
                                    box)<strong>Product&nbsp;Details:</strong>
                                    <div>
                                        <span
                                            style="color: rgb(255, 0, 0);"><strong>Disclaimer&nbsp;:</strong></span><strong>About&nbsp;Size:</strong>You'd&nbsp;better&nbsp;according&nbsp;your&nbsp;feet&nbsp;length&nbsp;to&nbsp;choose&nbsp;the&nbsp;corresponding&nbsp;size&nbsp;instead&nbsp;of&nbsp;size&nbsp;your&nbsp;usually&nbsp;wear,&nbsp;as&nbsp;each&nbsp;company&nbsp;has&nbsp;his&nbsp;own&nbsp;defined&nbsp;size&nbsp;chart,&nbsp;which&nbsp;may&nbsp;be&nbsp;different&nbsp;with&nbsp;others.&nbsp;Please&nbsp;take&nbsp;your&nbsp;own&nbsp;measurements&nbsp;and&nbsp;choose&nbsp;your&nbsp;size&nbsp;accordingly&nbsp;.&nbsp;we&nbsp;cannot&nbsp;accept&nbsp;responsibility&nbsp;for&nbsp;incorrect&nbsp;purchases.&nbsp;<strong>About&nbsp;Color:</strong>The&nbsp;precise&nbsp;color&nbsp;of&nbsp;the&nbsp;items&nbsp;may&nbsp;vary&nbsp;depending&nbsp;on&nbsp;the&nbsp;specific&nbsp;monitor,the&nbsp;settings&nbsp;and&nbsp;the&nbsp;lighting&nbsp;conditions.The&nbsp;items&nbsp;colors&nbsp;depicted&nbsp;should&nbsp;only&nbsp;be&nbsp;used&nbsp;as&nbsp;an&nbsp;approximate&nbsp;guide.<strong>About
                                            Smell:</strong>&nbsp;The&nbsp;Shoes&nbsp;may&nbsp;have&nbsp;smell&nbsp;because&nbsp;of&nbsp;glue,&nbsp;shoe&nbsp;polish,&nbsp;and&nbsp;completely&nbsp;sealed&nbsp;during&nbsp;transportation.Please&nbsp;put&nbsp;them&nbsp;in&nbsp;a&nbsp;place&nbsp;with&nbsp;good&nbsp;ventilation&nbsp;for&nbsp;several&nbsp;days.&nbsp;<strong>About&nbsp;Review:</strong>
                                        <div>Hope you enjoy shopping. If you had something unsatisfied, please email to
                                            service@banggood.com.We will resolve the issues immediately.Please give us
                                            the opportunity to resolve any problem. If you are satisfied with our
                                            service, please leave us a 5 star positive feedback. Your recognition will
                                            make us more confident to develop business and serve you better.</div>
                                        <div>
                                            <div><strong>How to choose your size:</strong></div>
                                            <div>1.Keep your center of gravity over the point where your foots are
                                                parallel.</div>
                                            <div>2.The unit of our chart is millimeter.If your left foots is different
                                                with the right one, you should choose the size according to the bigger
                                                foot.</div>
                                            <div>3.The deviation may happen if you use incorrect method.</div>
                                            <div>4.If your instep and your foot type are bigger than ordinary, you 'd
                                                better choose a larger size. Otherwise, you should choose a small one.
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <script
                    ...
                    type="text/javascript"></script>
                <script src="//cdn.shopify.com/s/files/1/0084/1144/7356/t/3/assets/jquery.fancybox.js?0"
                    type="text/javascript"></script>
            </div>
